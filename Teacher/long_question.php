    ...
    <body>
        ...
        <label for=" floatingTextarea">Marks</label>
                    ...
                    if (isset($_POST['add_question'])) {
                        ...
                        $check = "SELECT * FROM questions WHERE question_text = '$getQuestion'";
                    ...
                    ?>
                        ...
                        <?php
                            ...
                            $addQuestion = "INSERT INTO questions (question_text,question_mark) values('$getQuestion','$getMarks')";
                            $add =  mysqli_query($conn, $addQuestion);
                        ?>
