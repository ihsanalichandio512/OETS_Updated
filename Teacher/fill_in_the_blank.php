...
?>
    ...
    <body>
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Answer" name="answer" id="floatingTextarea""></input>
        <label for=" floatingTextarea">Answer</label>
                        </div>
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Marks" name="marks" id="floatingTextarea""></input>
        <label for=" floatingTextarea">Marks</label>
                    ...
                    INNER join subjects ON exams.subject_id = subjects.subject_id WHERE exam_type = 'fill_in_the_blanks'";
                        ...
                        <button type="submit" name="add" class="btn btn-primary my-2">Save</button>
                    </form>
                    ...
                    if (isset($_POST['add'])) {
                        ...
                        $check = "SELECT * FROM fill_in_the_blanks WHERE question_text = '$getQuestion'";
                    ...
                    ?>
                        ...
                        <?php
                            ...
                            $addtrue = "INSERT INTO fill_in_the_blanks( question_text, correct_answer, exam_id,question_mark) VALUES ('$getQuestion','$getAnswer','$getExam','$getMarks')";
