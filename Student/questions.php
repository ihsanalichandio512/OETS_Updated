                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        foreach ($_POST as $key => $value) {
                                            if (strpos($key, 'answer_') !== false) {
                                                ...
                                                $insert_query = "
                                                INSERT INTO answers( question_id, user_id, semester_id,exam_id,batch_id, answer_text,question_type) VALUES ('$question_id','$getUser_id','$getUserSemester','$GET_ID_OF_EXAM','$batch_id','$answer','long_answer')
                                                ";
