                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" value="True" type="radio" name="answer_<?php echo $question_id; ?>" id="flexRadioDefault1_<?php echo $question_id; ?>">
                                                    <label class="form-check-label" for="flexRadioDefault1_<?php echo $question_id; ?>">
                                                        True
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" value="False" type="radio" name="answer_<?php echo $question_id; ?>" id="flexRadioDefault2_<?php echo $question_id; ?>">
                                                    <label class="form-check-label" for="flexRadioDefault2_<?php echo $question_id; ?>">
                                                        False
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        foreach ($_POST as $key => $value) {
                                            if (strpos($key, 'answer_') !== false) {
                                                ...
                                                if (!empty($question_id)) {
                                                    ...
                                                    $insert_query = "
                                                        INSERT INTO `answers` (question_id, user_id, semester_id, exam_id, answer_text,question_type)
                                                        VALUES ('$question_id', '$getUser_id', '$getUserSemester', '$GET_ID_OF_EXAM', '$answer','true_false_question')";
