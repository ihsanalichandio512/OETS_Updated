                    ...
                    <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                        <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                            <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                                ...
                                <?php 
                                $multiple_choice_questions = "SELECT * from multiple_choice_questions ORDER BY RAND()";
                                ...
                                <input class="form-check-input" value="A" type="radio" name="flexRadioDefault"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" value="B" type="radio" name="flexRadioDefault"
                                    id="flexRadioDefault1">
                                <label class="form-check-label" for="flexRadioDefault1">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" value="C" type="radio" name="flexRadioDefault"
                                    id="flexRadioDefault1">
                                <label class="form-check-label" for="flexRadioDefault1">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" value="D" type="radio" name="flexRadioDefault"
                                    id="flexRadioDefault1">
                                <label class="form-check-label" for="flexRadioDefault1">
