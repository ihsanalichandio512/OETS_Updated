        ...
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                ...
                ?>
                            ...
                            $getSemester = "SELECT students.semester_id 
                FROM students
                INNER JOIN semesters ON students.semester_id = semesters.semester_id
                WHERE students.user_id = '$user_id'";
                
                $get = mysqli_query($conn,$getSemester);
               $semes =  mysqli_fetch_array($get);
                $_SESSION['semester_id'] = $semes['semester_id'];
